...
Disclaimer: This is a **prototype** machine learning app built on a **limited** dataset with **limited** computing capabilities, we are unable to guarantee 100% accuracy in the detection of hand gestures
